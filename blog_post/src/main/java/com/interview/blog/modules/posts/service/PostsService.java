...
import com.interview.blog.modules.posts.repository.PostsRepository;
import com.interview.blog.MyBeanCopy;
...
public class PostsService {
    ...
    public Page<Posts> findBySearch(Posts posts, Pageable pageable) {
        return postsRepository.findBySearch(posts, (posts.getTags()!= null ? (long) posts.getTags().size() : 0),pageable);
    }
}
